...
type AllCollisions =
{
	collision_ball1_paddle1: number;
	collision_ball1_paddle2: number;
	collision_ball1_wall: boolean;
	ball1_loser: number;

	collision_ball2_paddle1: number;
	collision_ball2_paddle2: number;
	collision_ball2_wall: boolean;
	ball2_loser: number;
...
// Music
const music_Bavaria: HTMLAudioElement = new Audio('Music_Meanwhile_in_Bavaria.mp3');
const music_MushroomKingdom: HTMLAudioElement = new Audio('Music_Mushroom_Kingdom.mp3');
const music_NumberOne: HTMLAudioElement = new Audio('Music_We_Are_Number_One.mp3');
const music_Stubb: HTMLAudioElement = new Audio('Music_Stubb_a_Dubb.mp3');
...
// Gnome
const image_Gnome: HTMLImageElement = new Image(161, 178);
image_Gnome.src = "Image_Gnome.png";
const audio_Gnome: HTMLAudioElement = new Audio('SoundEffect_Gnome.mp3');

// King Harkinian
const video_Harkinian_Hit = document.createElement('video');
video_Harkinian_Hit.src = 'Video_Harkinian_Hit.mp4';
const audio_Harkinian_Hit: HTMLAudioElement = new Audio('SoundEffect_Harkinian_Hit.mp3');
const audio_Harkinian_Oah: HTMLAudioElement = new Audio('SoundEffect_Harkinian_Oah.mp3');

// Fox
const image_Fox_bad: HTMLImageElement = new Image(50, 49);
image_Fox_bad.src = "Image_Fox_bad.png";
const image_Fox_good: HTMLImageElement = new Image(50, 49);
image_Fox_good.src = "Image_Fox_good.png";
const image_Fox_enraged: HTMLImageElement = new Image(50, 49);
image_Fox_enraged.src = "Image_Fox_enraged_ORIGINAL.png";
const audio_Fox_Enrage: HTMLAudioElement = new Audio('SoundEffect_Fox_Enrage.mp3');
// Good sounds
const audio_Fox_Meow: HTMLAudioElement = new Audio('SoundEffect_Fox_Meow.mp3');
const audio_Fox_Woof: HTMLAudioElement = new Audio('SoundEffect_Fox_Woof.mp3');
const audio_Fox_Quack: HTMLAudioElement = new Audio('SoundEffect_Fox_Quack.mp3');
const audio_Fox_Chicken: HTMLAudioElement = new Audio('SoundEffect_Fox_Chicken.mp3');
const audio_Fox_Goat: HTMLAudioElement = new Audio('SoundEffect_Fox_Goat.mp3');
const audio_Fox_Pig: HTMLAudioElement = new Audio('SoundEffect_Fox_Pig.mp3');
const audio_Fox_Tweet: HTMLAudioElement = new Audio('SoundEffect_Fox_Tweet.mp3');
// Evil sounds
const audio_Fox_Ahee: HTMLAudioElement = new Audio('SoundEffect_Fox_Ahee.mp3');
const audio_Fox_Cha: HTMLAudioElement = new Audio('SoundEffect_Fox_Cha.mp3');
const audio_Fox_Kaka: HTMLAudioElement = new Audio('SoundEffect_Fox_Kaka.mp3');
const audio_Fox_Papa: HTMLAudioElement = new Audio('SoundEffect_Fox_Papa.mp3');
const audio_Fox_Yok: HTMLAudioElement = new Audio('SoundEffect_Fox_Yok.mp3');
...
function drawGnome(timestamp): void
{
	if (isUnlocked_Gnome)
	{
		if (gnome_isActive === false)
...
function collisionCheck_ballPaddle(ball_futureX, ball_futureY): number
{
	let collision = 0;
...
function collisionCheck_ballWall(ball_futureX, ball_futureY): boolean
{
	let collision = false;
...
function collisionCheck_lostBall(ball_futureX, ball_futureY): number
{
	let whoLostBall = 0;
...
function collisionCheck_foxBall(ballx, bally, fox_width, fox_height): string
{
	let collision = "";
...
function collisionCheck_foxPaddle(paddlex, paddley, fox_width, fox_height): boolean
{
	let collision = false;
...
function collisionCheck_foxWall(fox_width, fox_height): string
{
	let collision = "";
...
function moveFox(timestamp): void
{
	if (isUnlocked_Fox)
	{
		if (fox_isAttacking)
...
function harkinian_hit(random_number): void
{
	var mod = 1;
